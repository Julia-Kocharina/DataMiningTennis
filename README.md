...
├── data/
│   ├── visualisations/                 
│   │   └── # Visualisations generated by 01_eda_analysis.py
│   │
│   ├── cleaned_2000_2026.csv          
...
│   │
│   ├── train.csv                      
│   │   └── # Training dataset generated by 03_train_test_split.py
│   │
│   └── test.csv                       
│       └── # Test dataset generated by 03_train_test_split.py
│
├── pipeline/
│   ├── 01_eda_analysis.py             
│   │   └── # Exploratory Data Analysis & visualisations
│   │
│   ├── 02_preprocessing_feature_eng.py
│   │   └── # Data preprocessing & feature engineering
│   │        # Outputs cleaned_2000_2026.csv
│   │
...
│   │        # - Elo Baseline
│   │
│   ├── 05_some_algorithm.py           
│   │   └── # TBD
│   │
│   ├── 06_some_algorithm.py           
│   │   └── # TBD
│   │
│   └── 07_some_algorithm.py           
│       └── # TBD
│
├── Project_Report.pdf                 
